...
// dep: ext.three
import {
    THREE as _THREE, SVGLoader, BufferGeometryUtils,
    LineMaterial, Line2, LineGeometry, LineSegments2,
    LineSegmentsGeometry, MeshBVHLib } from '../ext/three.js';

// Create a mutable copy of the THREE namespace so we can add custom properties.
// ES module namespace objects are frozen, but the underlying prototype objects are mutable.
const THREE = Object.assign({}, _THREE);

// Make THREE available globally
self.THREE = THREE;
THREE.BufferGeometryUtils = BufferGeometryUtils;
THREE.SVGLoader = SVGLoader?.SVGLoader || SVGLoader;
